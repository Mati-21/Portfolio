            ...
            >
              ...
              <form className="text-black">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full py-2 px-4 bg-gradient-to-r from-violet-600 to-violet-400 rounded-lg shadow-md hover:shadow-lg hover:from-violet-600 hover:to-purple-600 transition-all duration-300 text-white"
                >
                  Send Message
                </motion.button>
              </form>
